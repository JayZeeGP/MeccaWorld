...
tryAgain:
	...
	protected final void mNL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		{
		boolean synPredMatched3923 = false;
		if (((LA(1)=='\r') && (LA(2)=='\n'))) {
			int _m3923 = mark();
			synPredMatched3923 = true;
			inputState.guessing++;
			try {
				{
				match("\r\n");
				...
				synPredMatched3923 = false;
			}
			rewind(_m3923);
inputState.guessing--;
		}
		if ( synPredMatched3923 ) {
			match("\r\n");
		}
		else if ((LA(1)=='\n')) {
			match('\n');
	...
	public final void mLIT_NUMERO(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt3954>=1 ) { break _loop3954; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
		...
		if ((LA(1)=='e')) {
			...
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt3961>=1 ) { break _loop3961; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
