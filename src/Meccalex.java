...
tryAgain:
	...
	protected final void mNL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		{
		boolean synPredMatched20894 = false;
		if (((LA(1)=='\r') && (LA(2)=='\n'))) {
			int _m20894 = mark();
			synPredMatched20894 = true;
			inputState.guessing++;
			try {
				{
				match("\r\n");
				...
				synPredMatched20894 = false;
			}
			rewind(_m20894);
inputState.guessing--;
		}
		if ( synPredMatched20894 ) {
			match("\r\n");
		}
		else if ((LA(1)=='\n')) {
			match('\n');
	...
	public final void mLIT_NUMERO(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt20925>=1 ) { break _loop20925; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
		...
		if ((LA(1)=='e')) {
			...
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt20932>=1 ) { break _loop20932; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
